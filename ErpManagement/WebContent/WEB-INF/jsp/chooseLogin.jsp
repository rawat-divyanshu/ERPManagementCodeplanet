							...
							<div class="row align-items-center">
									...
									<form action="login" method="post">
										...
										<div class="form-group">
											<input type="submit" class="btn btn-danger btn-pill"
												value="Admin" style="width: 300px; height: 50px;">
										</div>
									</form>
								</div>
								<br> <br> <br>
								<div class="col-lg-5 ml-auto" data-aos="fade-up"
									...
									<form action="login" method="post">
										...
										<div class="form-group">
											<input type="submit" class="btn btn-danger btn-pill"
												value="Student" style="width: 300px; height: 50px;">
										</div>
									</form>
								</div>
								<br> <br> <br>
							...
							<c:forEach items="${list}" var="l" varStatus="loop">
								<figure class="m-0">
									<a href="course-single.html"><img
										src="images/courses/${l.photolink }" alt="Image"
										class="img-fluid"></a>
								</figure>
								<div class="course-inner-text py-4 px-4">
									<span class="course-price">${l.coursePrice }</span>
									<div class="meta">
										<span class="icon-clock-o"></span>${l.courseDuration }</div>
									<h3>
										<a href="#">${l.courseName }</a>
									</h3>
									<h4>${l.courseType }</h4>
									<p>Their is some words about something and you should read
										them.</p>
								</div>
								<div class="d-flex border-top stats">
									<div class="py-3 px-4">
										<span class="icon-users"></span> ${l.noOfStudent } students
									</div>
			...
			<div class="container">
				...
				<div class="row mb-5 align-items-center">
					<div class="col-lg-7 mb-5 order-1 order-lg-2" data-aos="fade-up"
						data-aos-delay="100">
						<img src="images/undraw_teaching.svg" alt="Image"
							class="img-fluid">
					</div>
					<div class="col-lg-4 mr-auto order-2 order-lg-1" data-aos="fade-up"
						...
						<div class="d-flex align-items-center custom-icon-wrap mb-3">
							<span class="custom-icon-inner mr-3"><span
								class="icon icon-graduation-cap"></span></span>
							<div>
								<h3 class="m-0">22,931 Yearly Gradua tes</h3>
							</div>
						</div>
					...
					<c:forEach items="${list1}" var="l1" varStatus="loop">
						<div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up"
							...
							<div class="teacher text-center">
								<img src="images/faculty/${l1.photoLink }" alt="Image"
								...
								<div class="py-2">
									...
									<p>Lorem ipsum dolor sit amet, consectetur adipisicing
										elit. Porro eius suscipit delectus enim iusto tempora,
										adipisci at provident.</p>
									<form action="moreFacultyDetail" method="post">
										<input type="hidden" name="id" value="${l1.id }"> <input
											type="submit" class="btn btn-primary" value="More..">
									</form>
								</div>
							</div>
						</div>
