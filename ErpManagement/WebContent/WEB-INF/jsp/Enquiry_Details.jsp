		...
		<header class="site-navbar py-4 js-sticky-header site-navbar-target"
			...
			<div class="container-fluid">
				<div class="d-flex align-items-center">
					...
					<button type="Submit" class="btn btn-primary" onClick="modalOpen()"
						data-toggle="modal" data-dismiss="modal">Interested
						Courses</button>
		</header>
						...
						<div class="col-12">
							<div class="row align-items-center">
								<div class="col-lg-6 mb-4">
									<h1 data-aos="fade-up" data-aos-delay="100">Welcome
										${Full_Name }</h1>
									<br>
								</div>
								<c:forEach items="${enquiry_details}" var="ed" varStatus="loop">
									...
									<div class="col-lg-5 ml-auto" data-aos="fade-up"
										...
										<form action="addEnquiry" method="post">
											...
											<div class="form-group">
												<label for="epassout">Year_Passout</label> <input
													type="text" class="form-control" id="Year_Passout"
													name="Year_Passout" required value="${Year_Passout }">
											</div>
											<div class="form-group">
