...
<html lang="en">
 ...
 {   
  ...
  <div class="site-wrap">
            ...
            <div class="col-12">
              <div class="row align-items-center">
                <div class="col-lg-6 mb-4">
                  ...
                  <p class="mb-4"  data-aos="fade-up" data-aos-delay="200">Everything you need for better future and success has already been written. And guess what? All you have to do is go to library.</p>
                  <p data-aos="fade-up" data-aos-delay="300"><a href="chooselogin" class="btn btn-primary py-3 px-5 btn-pill">Login</a></p>

                </div>

                <div class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="500">
                  <form action="signup" method="post" class="form-box" onsubmit="return validate()">
                    <h3 class="h4 text-black mb-4"> Guest Sign Up</h3>
                    <div class="form-group">
                      <input type="email" name="emailid" class="form-control" placeholder="Email Addresss">
                    </div>
                    ...
                    <div class="form-group mb-4">
                      <input type="password" id="cpwd" name="confirmpassword" class="form-control" placeholder="Re-type Password">
                    </div>
                    <div class="form-group">
    ...
    <div class="site-section courses-title" id="book-section">
      <div class="container">
        <div class="row mb-5 justify-content-center">
          <div class="col-lg-7 text-center" data-aos="fade-up" data-aos-delay="">
            <h2 class="section-title">Academic Books</h2>
          </div>
        </div>
      </div>
    </div>
     ...
     <c:forEach items="${list}" var="l" varStatus="loop">
          ...
          <div class="owl-carousel col-12 nonloop-block-14">
            ...
            <div class="course bg-white h-100 align-self-stretch">
              <figure class="m-0">
                <a href="course-single.html"><img src="images/courses/${l.photolink }" alt="Image" class="img-fluid"></a>
              </figure>
              <div class="course-inner-text py-4 px-4">
                <span class="course-price">${l.coursePrice }</span>
                <div class="meta"><span class="icon-clock-o"></span>${l.courseDuration }</div>
                <h3><a href="#">${l.courseName }</a></h3>
                <h4>${l.courseType }</h4>
                <p>Their is some words about something and you should read them.</p>
              </div>
              <div class="d-flex border-top stats">
                <div class="py-3 px-4"><span class="icon-users"></span> ${l.noOfStudent } students</div>
    ...
    <div class="site-section" id="magazine-section">
      <div class="container">
        <div class="row mb-5 justify-content-center">
          <div class="col-lg-7 text-center"  data-aos="fade-up" data-aos-delay="">
            <h2 class="section-title"> Latest Magazine</h2>
    ...
    <div class="site-section" id="newspaper-section">
      <div class="container">
        ...
        <div class="row">
                 ...
                 <c:forEach items="${list1}" var="l1" varStatus="loop">
          <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="100">
            <div class="teacher text-center">
              <img src="images/faculty/${l1.photoLink }" alt="Image" class="img-fluid w-50 rounded-circle mx-auto mb-4">
              <div class="py-2">
                <h3 class="text-black">${l1.facultyName }</h3>
                <p class="position">${l1.facultySubject } Teacher</p>
                ...
                <form action="moreFacultyDetail" method="post">
