...
<body>
	<div style="right-margin: 30%; left-margin: 30%;align:center;">
		<form style="align:center;"
			class="form-horizontal" action="enrollStudent">

				<h2>
					<center><strong>Enroll Student</strong></center>
				</h2>
			...
			<c:choose>
				...
				<div class="form-group">
					...
					<div class="col-md-5">
						<input id="courseFee" name="courseFee" type="text" placeholder="Course Fee" 
				...
				<div class="form-group">
					...
					<div class="col-md-5">
						<select id="batch" name="batchId" class="form-control" required>
							<option value="" disabled selected hidden>Select Preferred Batch</option>
				...
				<div class="form-group">
					<label class="col-md-4 control-label" for="">Fee Payment
						Type</label>
					<div class="col-md-4">
						<select id="feePaymentType" name="feePaymentType" class="form-control"  onchange="change(event)">
				...
				<div class="form-group">
					<label class="col-md-4 control-label" for="">Amount
						Deposited</label>
					<div class="col-md-5">
						<input id="amountDeposited"  name="amountDeposited" type="text" placeholder="Amount Deposited"
							class="form-control input-md" required>
